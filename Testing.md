...
querubo<!--$LastRefreshTime-->LastRefreshTime<!--/$LastRefreshTime-->, 부터 **<!--$DeploymentName-->DeploymentName<!--/$DeploymentName-->** 은 향상된 알고리즘을 사용하여 컴퓨터 키를 암호화하지 않습니다. <!--$LastRefreshTime-->LastRefreshTime<!--/$LastRefreshTime--> 이후에는 Cloud Service 배포를 재배포하거나 삭제하지 않는 한 이 상태가 올바릅니다.
